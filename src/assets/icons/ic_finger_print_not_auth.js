...
function SvgComponent(props) {
  return (
    <Svg
      ...
      <Path
        d="M53.502 43.001a37.39 37.39 0 01-2.802 14.25M51.592 38a7.5 7.5 0 00-13.09 5.001 22.399 22.399 0 01-2.81 10.896"
        stroke="#fff"
        strokeWidth={2.5}
        strokeLinecap="round"
      ...
      />
      <Path
        d="M41 28.855A15.01 15.01 0 0161 43a45.142 45.142 0 01-1.115 10M29.64 49.25c.9-1.96 1.363-4.092 1.36-6.25a14.964 14.964 0 015-11.18M43.278 55.501c-.317.69-.659 1.366-1.026 2.028M45.998 43.001c.002 2.53-.316 5.05-.945 7.5"
        stroke="#fff"
        strokeWidth={2.5}
        strokeLinecap="round"
        strokeLinejoin="round"

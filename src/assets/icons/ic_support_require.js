  ...
  return (
    <Svg
      ...
      <G mask="url(#prefix__a)" fill="#00B495">
        ...
        <Ellipse opacity={0.1} cx={45.5} cy={81.5} rx={30.5} ry={4.5} />
      </G>
      <Path
        d="M46 10.5A32.5 32.5 0 1078.5 43 32.538 32.538 0 0046 10.5zm0 15a3.75 3.75 0 110 7.5 3.75 3.75 0 010-7.5zm2.5 35H46a2.497 2.497 0 01-2.5-2.5V43a2.5 2.5 0 010-5H46a2.497 2.497 0 012.5 2.5v15a2.5 2.5 0 010 5z"
